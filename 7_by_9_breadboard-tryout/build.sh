...
docker run -t -v $PWD:/workspace  logickee/pcb-cicd make ci_plot_gerber   &
docker run -t -v $PWD:/workspace  logickee/pcb-cicd make ci_plot_pdf   &
docker run -t -v $PWD:/workspace  logickee/pcb-cicd make ci_plot_svg   &
